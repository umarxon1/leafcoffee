...
export const products: Product[] = [
  ...
  },
  {
    id: 3,
    img: "/product2.jpg",
    title: "Айс-мокко с шоколадом и фисташкой",
    description:
      "Холодный напиток, на основе молока, двойного эспрессо, шоколадного топпинга и фирменного соуса `Фисташка`",
    price: "75 000",
  },
  {
    id: 4,
  ...
  },
  {
    id: 8,
    img: "/product7.jpg",
    title: "Фисташковый Сан-Себастьян",
    description: "Запечённый чизкейк с добавлением фисташковой пасты",
    price: "335 000",
  },
  {
    id: 9,
