...
const Products = () => {
  ...
  return (
    ...
    <div className='container grid grid-cols-4 gap-8 max-lg1:grid-cols-3 max-md:grid-cols-2 '>
        {products.map((el,i)=> {
            return(
                <div className='rounded-xl transition shadow-sm flex ease-in hover:shadow-lg overflow-hidden ' key={i}>
                   ...
                   <div className='px-[20px] pb-[20px] flex flex-col '>
                     <h3 className='h-[60px] text-[18px] text-[#371C06] hover:underline cursor-pointer max-lg1:text-[14px] max-sm1:text-[11px]'>{el.title}</h3>
